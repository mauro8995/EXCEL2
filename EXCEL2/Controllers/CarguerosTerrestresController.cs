...
namespace EXCEL2.Controllers
{
    public class CarguerosTerrestresController : Controller
    {
		...
		public ActionResult GenerarArchivoCarguerosPostpagoConDetraccion(int idPanel)
		{
			...
			byte[] bytesDelExcel =  System.IO.File.ReadAllBytes(filePath); // Reemplaza esto con tus propios datos
		...
		public ActionResult GenerarArchivoCarguerosPrepagoConDetraccion(int idPanel)
		{
			ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
		...
		public ActionResult GenerarArchivoCarguerosPrepagoSinDetraccion(int idPanel)
		{
			ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
		...
		public ExcelPackage CarguerosPrepagoConDetraccion(ExcelPackage package,int idPanel)
		{
			...
			hoja2.Cells["I4"].Value = fecha.C8_PRE_COMPROBANTESREPORTES_3_PRE_MONTORECARGA_PRE_SUMAREGARGAS; 
			hoja2.Cells["I5"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_SALDOCOVISOL_PREPAGO_CONSUMOSCOVISOL_PRE;
			hoja2.Cells["I6"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_SALDOCOVISUR_PREPAGO_CONSUMOSCOVISUR_PRE;
			hoja2.Cells["I7"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_SALDOCOVIPERU_PREPAGO_CONSUMOSCOVIPERU_PRE;

			hoja2.Cells["J3"].Value = fecha.C3_ND_SALDODELULTIMOREPORTE;
			hoja2.Cells["J4"].Value = fecha.C8_PRE_COMPROBANTESREPORTES_3_PRE_MONTODETRACCION_PRE_SUMADETRACCIONES;
			hoja2.Cells["J5"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_CONSUDETRACCOVISO_SUMADETRACCOVISOL;
			hoja2.Cells["J6"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_CONSUDETRACCOVISUR_SUMADETRACCOVISUR;
			hoja2.Cells["J7"].Value = fecha.C8_GC_TRANSITOGENERALESSPREPAGO_3_ND_CONSUDETRACCOVIPERU_SUMADETRACCOVIPERU;
            ...
            foreach (var item in panel)
            {
				...
				hoja2.Cells["H" + contadorHoja2].Value = (item.C3_FE_FECHADECOMPROBANTE_PRE == null ? "": item.C3_FE_FECHADECOMPROBANTE_PRE.Value.ToString("dd/MM/yyyy HH:mm:ss")) ;
				hoja2.Cells["I" + contadorHoja2].Value = item.C3_PR4_TL_NUMERODECOMPROBANTE;
				hoja2.Cells["J" + contadorHoja2].Value = item.C3_PR4_TL_RUCCONSECION;
				hoja2.Cells["K" + contadorHoja2].Value = item.C3_PR4_TL_TIPODECOMPROBANTE;
				cantidadElementos++;
				contadorHoja2++;
		...
		public ExcelPackage CarguerosPostpagoConDestraccion(ExcelPackage package, int idPanel)
		{
			...
			hoja2.Cells["I3"].Value = fecha.C3_ND_SALDODELULTIMOREPORTE;
			hoja2.Cells["I4"].Value = fecha.C8_PR4_GC_RECIBODECOMPROBANTES_3_POST_MONTORECARGA_POST_ND_SUMARECARGAS;
			hoja2.Cells["I5"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVISOL_POST_SUMADECONSUMOCOVISOL;
			hoja2.Cells["I6"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVISUR_POST_SUMADECONSUMOCOVISUR;
			hoja2.Cells["I7"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVIPERU_POST_SUMADECONSUMOCOVIPER;

			hoja2.Cells["J3"].Value = fecha.C3_ND_SALDODELULTIMOREPORTE;
			hoja2.Cells["J4"].Value = fecha.C8_PR4_GC_RECIBODECOMPROBANTES_3_POST_MONTODETRACCION_POST_ND_SUMADETRACCI;
			hoja2.Cells["J5"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_DETRACCOVISOL_POST_SUMADETRACCOVISOL;
			hoja2.Cells["J6"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_DETRACCOVISUR_POST_SUMADETRACCOVISUR;
			hoja2.Cells["J7"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_DETRACCOVIPERU_POST_SUMADETRACCOVIPERU;
			...
			foreach (var item in dataHoja3)
			{
				...
				hoja3.Cells["B" + contadorHoja3].Value = item.C3_POST_COMPROBANTERECARGA == null ? "" : item.C3_POST_COMPROBANTERECARGA.Value.ToString("dd/MM/yyyy HH:mm:ss");
		...
		public ExcelPackage CarguerosPostpagoSinDestraccion(ExcelPackage package, int idPanel)
		{
			...
			hoja2.Cells["G5"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVISOL_POST_SUMADECONSUMOCOVISOL;
			hoja2.Cells["G6"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVISUR_POST_SUMADECONSUMOCOVISUR;
			hoja2.Cells["G7"].Value = fecha.C8_GC_TRANSITOSGENERALESPOSTPAGO_3_ND_CONSUMOSCOVIPERU_POST_SUMADECONSUMOCOVIPER;
